...
OBJECTS += AX12/AX12.o
OBJECTS += MX.o
OBJECTS += MX106/MX106.o
OBJECTS += MX64/MX64.o
OBJECTS += SerialHalfDuplex.o
OBJECTS += Servo/Servo.o
OBJECTS += communication_1/communication_1.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../AX12
INCLUDE_PATHS += -I../MX106
INCLUDE_PATHS += -I../MX64
INCLUDE_PATHS += -I../Servo
INCLUDE_PATHS += -I../communication_1
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1583227112.7890542
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1583227112.7890542
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/2/29a93566856fcc2c77fb06f3ad466aa3/Arm_dynamixel_can/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
